	...
	<div class='h_btm'>
		<div class='cssmenu'>
			<ul>
				...
				<li  class="active"><a href='${pageContext.request.getContextPath()}/successResult'><span>竞赛获奖</span></a></li>
...
<div class="main">
	...
	<%--</div>--%>
					...
					<%--<div class="services-grids">--%>
						...
						<%--</div>--%>
						<%--&lt;%&ndash;<div class="services-grid">&ndash;%&gt;--%>
							<%--&lt;%&ndash;<a href="">发明专利</a>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<p>1、张旱文，基于xxxxxxxxxxxxxxxxxxx系统，专利申请号：201711222374.6</p>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<p>2、专利2</p>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<p>3、专利3</p>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<p>4、专利4</p>&ndash;%&gt;--%>
						<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
						<%--<div class="services-grid">--%>
